    ...
    def _setup_few_shot_prompt(self):
        ...
        few_shot_examples = [
            {"input": "What measures does PMI take when transferring personal data to countries with different data protection standards?", 
             "output": "PMI ensures that any transfer of personal data to countries with different data protection standards is done with appropriate safeguards, such as EU Model Contracts, or other legal mechanisms that provide adequate protection."},
            {"input": "How does PMI handle cookies and tracking technologies on its digital touchpoints?", 
             "output": "PMI uses cookies and similar tracking technologies (such as pixels/web beacons) on its digital touchpoints to collect information about user interactions. This information is used to enhance user experience and for business analytics."},
            {"input": "What specific rights do users in Japan have regarding their personal information?", 
             "output": "Users in Japan have the right to be informed about the joint use of their personal information by PMI affiliates. PMI takes reasonable measures to protect this information, especially when transferred outside Japan."},
            {"input": "How does PMI ensure the confidentiality and security of personal data during processing?", 
             "output": "PMI implements strict security measures, including encryption, access controls, and secure data storage, to protect personal data during processing. PMI also monitors systems and devices to maintain data integrity."}
        ]
